...
## ソースコードの説明
l18~22 変数の宣言
l25    引数の数を決め、引数の足りないケースを弾く
l26~28 引数の値を入れるようにした
l37    平均の値の出力
l38    標準偏差の値の出力
l39    人数の出力
l43~47 身長の捏造を人数分繰り返す
l53以降は課題の説明に元々書かれていたため割愛。
...
- コードに修正点はなさそうに思いますが，このレポート Readme.mdを修正してください．
- 入出力結果をこのReadme.mdに加えてください．-DCONST_SEED　をつけてコンパイルしてできた実行ファイルと，つけないでコンパイルしてできた実行ファイルの2種類の結果です．