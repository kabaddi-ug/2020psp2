...
l10 各double変数の設置
l28~30 A県の標準化を行い、正規分布の式を求め、尤度を出す
l32~34 B県の標準化を行い、正規分布の式を求め、尤度を出す
l49 A県の尤度を出力
l50 B県の尤度を出力
l57~60 標準正規分布関数を返す
...
[comment #20200430]
- 入出力をReadme.mdにコピペしてください．
- A県の尤度とB県の尤度の大小比較からは，どんなことが言えますか．
- 尤度が最も高くなるような平均値と分散は何だと思いますか？それは，課題1で推定した母集団平均と母集団分散になっているはずです．逆に言うと，尤度が最大となるような意味で「最良」な推定値なのです．母集団分散が不偏分散の計算で求められる理由がこれです．確かめてみると面白いかも．